...
?>
        ...
        <h2>Data Pegawai</h2>
        <h3><a href="View_post_pegawai.php">Tambah Data</a></h3>
            ...
            <?php
                ...
                if(isset($GetPegawai))
                {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="../Views/View_put_pegawai.php?nip=<?php echo $Get['nip'] ?>">Ubah</a> |
                                <a href="../Config/Routes.php?function=delete_pegawai&nip=<?php echo $Get['nip'] ?>">Hapus</a>
                            </td>
                        </tr>
                        <?php 
                        }
